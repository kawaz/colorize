...
const tokens = {
  ...
  keyword:
    /\b(?:if|else|while|for|break|continue|return|function|class|let|const|var|this|super|extends|implements|interface|enum|import|export|default|module|namespace|import|export|from|as|of|yield|await)\b/,
