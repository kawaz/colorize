...
import { Tokens, AllTokens, LogLexer } from './lexer';
    ...
    this.OR([
      ...
      { 
        ...
        GATE: () => {
          ...
          // 識別子やTextの場合
          if (currentToken && (currentToken.tokenType === Tokens.Identifier || currentToken.tokenType === Tokens.Text)) {
            return nextToken && (nextToken.tokenType === Tokens.Colon || nextToken.tokenType === Tokens.Equals);
          }
          
          // 文字列の場合
          if (currentToken && (currentToken.tokenType === Tokens.StringLiteralDouble || currentToken.tokenType === Tokens.StringLiteralSingle)) {
            return nextToken && (nextToken.tokenType === Tokens.Colon || nextToken.tokenType === Tokens.Equals);
          }
